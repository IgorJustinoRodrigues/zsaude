...
export function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Cabeçalho */}
      <div>
        <h1 className="text-xl font-bold text-slate-900 dark:text-white">Usuários do sistema</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900 dark:text-white leading-none">{online.length}</p>
            <p className="text-xs text-slate-500 mt-0.5">Online agora</p>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900 dark:text-white leading-none">{offline.length}</p>
            <p className="text-xs text-slate-500 mt-0.5">Offline</p>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-sky-50 dark:bg-sky-950/40 flex items-center justify-center shrink-0">
            <span className="text-sm font-bold text-sky-500">{mockAllUsersPresence.length}</span>
          </div>
          <div>
            <p className="text-2xl font-bold text-slate-900 dark:text-white leading-none">{mockAllUsersPresence.length}</p>
