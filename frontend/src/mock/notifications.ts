...
export const mockNotifications: Notification[] = [
  // ── Não lidas ────────────────────────────────────────────────────────────────
  { id: 'n1',  type: 'error',   title: 'Resultado crítico – Carlos Mendes',     message: 'Resultado de Troponina I acima do valor crítico. Verificar imediatamente.',                       read: false, createdAt: d('2026-04-14T08:55:00') },
  ...
  // ── Lidas ────────────────────────────────────────────────────────────────────
  { id: 'n6',  type: 'success', title: 'Laudo liberado – Ana Beatriz',          message: 'Laudo do pedido #e1 foi liberado com sucesso pelo Dr. André Monteiro.',                           read: true,  createdAt: d('2026-04-14T08:30:00') },
