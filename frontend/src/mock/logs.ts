...
export const mockSystemLogs: SystemLog[] = [
  ...
  },
  {
    ...
    details: 'Alteração de nível de acesso realizada sem confirmação do segundo administrador (política de dupla aprovação). Usuário afetado: Paulo Henrique (usr9). Unidade: UBS Centro. Evento sinalizado pelo sistema de compliance para revisão.',
    ip: '201.73.45.12', userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/124',
    at: ago(200),
  },
  {
